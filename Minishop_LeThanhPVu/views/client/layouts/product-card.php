...
<div class="col">
    <div class="card product-card h-100 border-0 shadow-sm">
        ...
        <?php endif; ?>
        <a href="<?= $baseUrl ?>/product/<?= urlencode($p['slug']) ?>">
        ...
        <div class="card-body d-flex flex-column">
            ...
            <h6 class="card-title fw-bold mb-2">
                <a href="<?= $baseUrl ?>/product/<?= urlencode($p['slug']) ?>" class="text-dark text-decoration-none product-title"><?= htmlspecialchars($p['proname']) ?></a>
            </h6>
            <div class="mt-auto">
                <?php if ($hasDiscount): ?>
            ...
            <div class="d-flex gap-2 mt-3">
                <a href="<?= $baseUrl ?>/product/<?= urlencode($p['slug']) ?>" class="btn btn-outline-primary btn-sm flex-fill"><i class="bi bi-eye me-1"></i>Chi tiết</a>
                <button type="button" class="btn btn-primary btn-sm flex-fill btn-add-cart" data-productid="<?= $p['id'] ?>"><i class="bi bi-cart-plus me-1"></i>Mua</button>
            </div>
        </div>
    </div>
</div>
